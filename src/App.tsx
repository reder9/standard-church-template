...
document.documentElement.style.setProperty('--primary-color', churchConfig.primaryColor);
document.documentElement.style.setProperty('--secondary-color', churchConfig.secondaryColor);
